...
3) Access the `workbench` named `mar11-ragupdatedimage-2-notebook`.
...
5) In the terminal, run `cd mar11-ragupdatedimage-2` to navigate to your sample app's directory.
